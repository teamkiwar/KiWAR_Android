...
public class PointCloudRenderer {
    ...
    public void init() {
        ...
        GLES20.glBufferData(GLES20.GL_ARRAY_BUFFER, mMaxPoints * 4 * Float.BYTES, null, GLES20.GL_DYNAMIC_DRAW);
    ...
    public void update(PointCloud pointCloud) {
        ...
        GLES20.glBufferSubData(GLES20.GL_ARRAY_BUFFER, 0, mNumPoints * 4 * Float.BYTES, mPointCloud.getPoints());
        GLES20.glBindBuffer(GLES20.GL_ARRAY_BUFFER, 0);
    }

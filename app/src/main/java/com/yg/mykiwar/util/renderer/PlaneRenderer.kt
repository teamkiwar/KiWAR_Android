 ...
 */
package com.yg.mykiwar.util.renderer
...
import com.yg.mykiwar.temp.PlaneRendererT
import com.yg.mykiwar.util.helper.ShaderUtil
...
class PlaneRenderer {
    ...
    companion object {
        ...
        private val PLANE_COLORS_RGBA = intArrayOf(-0x1, -0xbbcc901, -0x16e19c01, -0x63d84f01, 0x673AB7FF, 0x3F51B5FF, 0x2196F3FF, 0x03A9F4FF, 0x00BCD4FF, 0x009688FF, 0x4CAF50FF, -0x743cb501, -0x3223c601, -0x14c401, -0x3ef801, -0x67ff01)
    }
}
